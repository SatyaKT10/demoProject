/**
 ...
 (function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     * =============================================================================
     */
    var FACEMESH_GRAPHMODEL_PATH = 'https://cdn.shopify.com/s/files/1/0084/6957/7794/files/';
    var IRIS_GRAPHMODEL_PATH = 'https://cdn.shopify.com/s/files/1/0084/6957/7794/files/';
    ...
    function loadMeshModel(modelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, tfconv.loadGraphModel(FACEMESH_GRAPHMODEL_PATH, { fromTFHub: true }, "facemesh.json")];
            });
        });
    }
    function loadIrisModel(modelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, tfconv.loadGraphModel(IRIS_GRAPHMODEL_PATH, { fromTFHub: true }, "iris.json")];
            });
        });
    }
